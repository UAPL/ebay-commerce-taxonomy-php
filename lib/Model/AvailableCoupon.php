...
class AvailableCoupon implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'constraint' => '\Uapl\Ebay\Buy\Browse\Model\CouponConstraint',
        'discount_amount' => '\Uapl\Ebay\Buy\Browse\Model\Amount',
     ...
     * Gets constraint
     *
     * @return \Uapl\Ebay\Buy\Browse\Model\CouponConstraint|null
     */
     ...
     * Sets constraint
     *
     * @param \Uapl\Ebay\Buy\Browse\Model\CouponConstraint|null $constraint constraint
     *
     * @return self
     */
     ...
     *
     * @return \Uapl\Ebay\Buy\Browse\Model\Amount|null
     */
     ...
     *
     * @param \Uapl\Ebay\Buy\Browse\Model\Amount|null $discount_amount discount_amount
     *
     * @return self
     */
     ...
     * Sets message
     *
     * @param string|null $message A description of the coupon. Note: The value returned in the termsWebUrl field should appear for all experiences when displaying coupons. The value in the availableCoupons.message field must also be included, if returned in the API response.
     *
     * @return self
     */
     ...
     * Sets terms_web_url
     *
     * @param string|null $terms_web_url The URL to the coupon terms of use. Note: The value returned in the termsWebUrl field should appear for all experiences when displaying coupons. The value in the availableCoupons.message field must also be included, if returned in the API response.
     *
     * @return self
     */
