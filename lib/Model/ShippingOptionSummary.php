...
class ShippingOptionSummary implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param string|null $shipping_cost_type Indicates the type of shipping used to ship the item. Possible values are FIXED (flat-rate shipping) and CALCULATED (shipping cost calculated based on item and buyer location).
     *
     * @return self
     */
