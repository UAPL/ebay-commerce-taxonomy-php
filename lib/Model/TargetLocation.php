...
class TargetLocation implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param string|null $unit_of_measure This value shows the unit of measurement used to measure the distance between the location of the item and the buyer's location. This value is typically mi or km.
     *
     * @return self
     */
