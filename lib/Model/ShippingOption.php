...
class ShippingOption implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'additional_shipping_cost_per_unit' => '\Uapl\Ebay\Buy\Browse\Model\ConvertedAmount',
        'cut_off_date_used_for_estimate' => 'string',
        'fulfilled_through' => 'string',
        'guaranteed_delivery' => 'bool',
        'import_charges' => '\Uapl\Ebay\Buy\Browse\Model\ConvertedAmount',
        'max_estimated_delivery_date' => 'string',
        'min_estimated_delivery_date' => 'string',
        'quantity_used_for_estimate' => 'int',
        'shipping_carrier_code' => 'string',
        'shipping_cost' => '\Uapl\Ebay\Buy\Browse\Model\ConvertedAmount',
        'shipping_cost_type' => 'string',
        'shipping_service_code' => 'string',
        'ship_to_location_used_for_estimate' => '\Uapl\Ebay\Buy\Browse\Model\ShipToLocation',
     ...
     *
     * @param \Uapl\Ebay\Buy\Browse\Model\ConvertedAmount|null $additional_shipping_cost_per_unit additional_shipping_cost_per_unit
     *
     * @return self
     */
     ...
     *
     * @param string|null $fulfilled_through If the item is being shipped by eBay's Global Shipping Program, this field returns GLOBAL_SHIPPING. Otherwise this field is null. For implementation help, refer to <a href='https://developer.ebay.com/api-docs/buy/browse/types/gct:FulfilledThroughEnum'>eBay API documentation</a>
     *
     * @return self
     */
     ...
     *
     * @param bool|null $guaranteed_delivery Indicates if the seller has committed to shipping the item with eBay Guaranteed Delivery. With eBay Guaranteed Delivery, the seller is committed to getting the line item to the buyer within 4 business days or less. See the Buying items with eBay Guaranteed Delivery help topic for more details about eBay Guaranteed Delivery.
     *
     * @return self
     */
     ...
     * Sets import_charges
     *
     * @param \Uapl\Ebay\Buy\Browse\Model\ConvertedAmount|null $import_charges import_charges
     *
     * @return self
     */
     ...
     * Sets shipping_cost
     *
     * @param \Uapl\Ebay\Buy\Browse\Model\ConvertedAmount|null $shipping_cost shipping_cost
     *
     * @return self
     */
     ...
     *
     * @param string|null $shipping_cost_type Indicates the class of the shipping cost. Valid Values: FIXED or CALCULATED Code so that your app gracefully handles any future changes to this list.
     *
     * @return self
     */
     ...
     *
     * @return \Uapl\Ebay\Buy\Browse\Model\ShipToLocation|null
     */
     ...
     *
     * @param \Uapl\Ebay\Buy\Browse\Model\ShipToLocation|null $ship_to_location_used_for_estimate ship_to_location_used_for_estimate
     *
     * @return self
     */
     ...
     *
     * @param string|null $trademark_symbol Any trademark symbol, such as &trade; or &reg;, that needs to be shown in superscript next to the shipping service name.
     *
     * @return self
     */
