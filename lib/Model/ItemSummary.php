...
class ItemSummary implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'categories' => '\Uapl\Ebay\Buy\Browse\Model\Category[]',
        'compatibility_match' => 'string',
        'compatibility_properties' => '\Uapl\Ebay\Buy\Browse\Model\CompatibilityProperty[]',
        'condition' => 'string',
        'condition_id' => 'string',
        'current_bid_price' => '\Uapl\Ebay\Buy\Browse\Model\ConvertedAmount',
        'distance_from_pickup_location' => '\Uapl\Ebay\Buy\Browse\Model\TargetLocation',
        ...
        'item_href' => 'string',
        'item_id' => 'string',
        'item_location' => '\Uapl\Ebay\Buy\Browse\Model\ItemLocationImpl',
        'item_web_url' => 'string',
        'legacy_item_id' => 'string',
        'marketing_price' => '\Uapl\Ebay\Buy\Browse\Model\MarketingPrice',
        'pickup_options' => '\Uapl\Ebay\Buy\Browse\Model\PickupOptionSummary[]',
        ...
        'seller' => '\Uapl\Ebay\Buy\Browse\Model\Seller',
        'shipping_options' => '\Uapl\Ebay\Buy\Browse\Model\ShippingOptionSummary[]',
        'short_description' => 'string',
        'thumbnail_images' => '\Uapl\Ebay\Buy\Browse\Model\Image[]',
        'title' => 'string',
     ...
     * Gets categories
     *
     * @return \Uapl\Ebay\Buy\Browse\Model\Category[]|null
     */
     ...
     * Sets categories
     *
     * @param \Uapl\Ebay\Buy\Browse\Model\Category[]|null $categories This container returns the primary category ID of the item (as well as the secondary category if the item was listed in two categories).
     *
     * @return self
     */
     ...
     *
     * @return \Uapl\Ebay\Buy\Browse\Model\CompatibilityProperty[]|null
     */
     ...
     *
     * @return \Uapl\Ebay\Buy\Browse\Model\TargetLocation|null
     */
     ...
     *
     * @param \Uapl\Ebay\Buy\Browse\Model\TargetLocation|null $distance_from_pickup_location distance_from_pickup_location
     *
     * @return self
     */
     ...
     * Sets item_end_date
     *
     * @param string|null $item_end_date The date and time up to which the item can be purchased. This value is returned in UTC format (yyyy-MM-ddThh:mm:ss.sssZ), which you can convert into the local time of the buyer. Note: This field is not returned for Good 'Til Cancelled (GTC) listings.
     *
     * @return self
     */
     ...
     *
     * @param string|null $item_group_href The HATEOAS reference of the parent page of the item group. An item group is an item that has various aspect differences, such as color, size, storage capacity, etc. Note: This field is returned only for item groups.
     *
     * @return self
     */
     ...
     * Sets item_href
     *
     * @param string|null $item_href The URI for the Browse API getItem method, which can be used to retrieve more details about items in the search results.
     *
     * @return self
     */
     ...
     * Gets item_location
     *
     * @return \Uapl\Ebay\Buy\Browse\Model\ItemLocationImpl|null
     */
     ...
     * Sets item_location
     *
     * @param \Uapl\Ebay\Buy\Browse\Model\ItemLocationImpl|null $item_location item_location
     *
     * @return self
     */
     ...
     * Gets pickup_options
     *
     * @return \Uapl\Ebay\Buy\Browse\Model\PickupOptionSummary[]|null
     */
     ...
     * Sets pickup_options
     *
     * @param \Uapl\Ebay\Buy\Browse\Model\PickupOptionSummary[]|null $pickup_options This container returns the local pickup options available to the buyer. This container is only returned if the user is searching for local pickup items and set the local pickup filters in the method request.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $priority_listing When true, this container indicates that the item is a priority listing. Priority Listings are a subset of eBay listings identified with a higher priority to be promoted. Note: Priority Listing is returned only with a Best Match sort and will not be returned for other sort options.
     *
     * @return self
     */
     ...
     * Gets seller
     *
     * @return \Uapl\Ebay\Buy\Browse\Model\Seller|null
     */
     ...
     * Sets seller
     *
     * @param \Uapl\Ebay\Buy\Browse\Model\Seller|null $seller seller
     *
     * @return self
     */
     ...
     *
     * @return \Uapl\Ebay\Buy\Browse\Model\ShippingOptionSummary[]|null
     */
     ...
     *
     * @param \Uapl\Ebay\Buy\Browse\Model\ShippingOptionSummary[]|null $shipping_options This container returns the shipping options available to ship the item.
     *
     * @return self
     */
     ...
     *
     * @param \Uapl\Ebay\Buy\Browse\Model\Image[]|null $thumbnail_images An array of thumbnail images for the item.
     *
     * @return self
     */
