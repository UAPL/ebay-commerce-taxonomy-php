...
class MarketingPrice implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'discount_amount' => '\Uapl\Ebay\Buy\Browse\Model\ConvertedAmount',
        'discount_percentage' => 'string',
        'original_price' => '\Uapl\Ebay\Buy\Browse\Model\ConvertedAmount',
     ...
     *
     * @param \Uapl\Ebay\Buy\Browse\Model\ConvertedAmount|null $discount_amount discount_amount
     *
     * @return self
     */
     ...
     *
     * @param string|null $discount_percentage This field expresses the percentage of the seller discount based on the value in the originalPrice container.
     *
     * @return self
     */
     ...
     * Sets original_price
     *
     * @param \Uapl\Ebay\Buy\Browse\Model\ConvertedAmount|null $original_price original_price
     *
     * @return self
     */
     ...
     *
     * @param string|null $price_treatment Indicates the pricing treatment (discount) that was applied to the price of the item. Note: The pricing treatment affects the way and where the discounted price can be displayed. For implementation help, refer to <a href='https://developer.ebay.com/api-docs/buy/browse/types/gct:PriceTreatmentEnum'>eBay API documentation</a>
     *
     * @return self
     */
