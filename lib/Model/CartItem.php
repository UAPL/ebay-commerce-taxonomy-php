...
class CartItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'cart_item_id' => 'string',
        'cart_item_subtotal' => '\Uapl\Ebay\Buy\Browse\Model\Amount',
        'image' => '\Uapl\Ebay\Buy\Browse\Model\Image',
        'item_id' => 'string',
        'item_web_url' => 'string',
        'price' => '\Uapl\Ebay\Buy\Browse\Model\Price',
        'quantity' => 'int',
        'title' => 'string'
    ];
     ...
     *
     * @param \Uapl\Ebay\Buy\Browse\Model\Amount|null $cart_item_subtotal cart_item_subtotal
     *
     * @return self
     */
     ...
     * Sets item_id
     *
     * @param string|null $item_id The RESTful identifier of the item. This identifier is generated when the item was listed. RESTful Item ID Format: v1|#|# For example: v1|2**********2|0 v1|1**********2|4**********2
     *
     * @return self
     */
     ...
     * Gets price
     *
     * @return \Uapl\Ebay\Buy\Browse\Model\Price|null
     */
     ...
     * Sets price
     *
     * @param \Uapl\Ebay\Buy\Browse\Model\Price|null $price price
     *
     * @return self
     */
