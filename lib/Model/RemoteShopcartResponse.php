...
class RemoteShopcartResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'cart_items' => '\Uapl\Ebay\Buy\Browse\Model\CartItem[]',
        'cart_subtotal' => '\Uapl\Ebay\Buy\Browse\Model\Amount',
        'cart_web_url' => 'string',
        'unavailable_cart_items' => '\Uapl\Ebay\Buy\Browse\Model\CartItem[]',
     ...
     * Gets cart_items
     *
     * @return \Uapl\Ebay\Buy\Browse\Model\CartItem[]|null
     */
     ...
     * Sets cart_items
     *
     * @param \Uapl\Ebay\Buy\Browse\Model\CartItem[]|null $cart_items An array of the items in the member's eBay cart.
     *
     * @return self
     */
     ...
     * Sets cart_subtotal
     *
     * @param \Uapl\Ebay\Buy\Browse\Model\Amount|null $cart_subtotal cart_subtotal
     *
     * @return self
     */
     ...
     *
     * @param \Uapl\Ebay\Buy\Browse\Model\CartItem[]|null $unavailable_cart_items An array of items in the cart that are unavailable. This can be for a variety of reasons such as, when the listing has ended or the item is out of stock. Because a cart never expires, these items will remain in the cart until they are removed.
     *
     * @return self
     */
     ...
     * Sets warnings
     *
     * @param \Uapl\Ebay\Buy\Browse\Model\Error[]|null $warnings An array of warning messages. These type of errors do not prevent the call from executing but should be checked.
     *
     * @return self
     */
