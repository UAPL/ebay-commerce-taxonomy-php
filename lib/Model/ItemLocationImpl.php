...
class ItemLocationImpl implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets city
     *
     * @param string|null $city The city in which the item is located. Restriction: This field is populated in the search method response only when fieldgroups = EXTENDED.
     *
     * @return self
     */
     ...
     * Sets country
     *
     * @param string|null $country The two-letter ISO 3166 standard code that indicates the country in which the item is located. For implementation help, refer to <a href='https://developer.ebay.com/api-docs/buy/browse/types/ba:CountryCodeEnum'>eBay API documentation</a>
     *
     * @return self
     */
     ...
     * Sets postal_code
     *
     * @param string|null $postal_code The postal code (or zip code in US) where the item is located. Sellers set a postal code (or zip code in US) for items when they are listed. The postal code is used for calculating proximity searches. It is anonymized when returned in itemLocation.postalCode via the API.
     *
     * @return self
     */
