...
class PickupOptionSummary implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param string|null $pickup_location_type This container returns the local pickup options available to the buyer. Possible values are ARRANGED_LOCATION and STORE.
     *
     * @return self
     */
