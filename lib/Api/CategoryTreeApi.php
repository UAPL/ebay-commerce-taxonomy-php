 ...
 *
 * @category Class
 * @package  Uapl\Ebay\Commerce\Taxonomy
...
namespace Uapl\Ebay\Commerce\Taxonomy\Api;
...
use Uapl\Ebay\Commerce\Taxonomy\ApiException;
use Uapl\Ebay\Commerce\Taxonomy\Configuration;
use Uapl\Ebay\Commerce\Taxonomy\HeaderSelector;
use Uapl\Ebay\Commerce\Taxonomy\ObjectSerializer;
...
class CategoryTreeApi
{
     ...
     *
     * @throws \Uapl\Ebay\Commerce\Taxonomy\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Uapl\Ebay\Commerce\Taxonomy\Model\GetCategoriesAspectResponse
     */
     ...
     * @throws \Uapl\Ebay\Commerce\Taxonomy\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Uapl\Ebay\Commerce\Taxonomy\Model\GetCategoriesAspectResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function fetchItemAspectsWithHttpInfo($category_tree_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Uapl\Ebay\Commerce\Taxonomy\Model\GetCategoriesAspectResponse' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Uapl\Ebay\Commerce\Taxonomy\Model\GetCategoriesAspectResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Uapl\Ebay\Commerce\Taxonomy\Model\GetCategoriesAspectResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Uapl\Ebay\Commerce\Taxonomy\Model\GetCategoriesAspectResponse',
     ...
     * @throws \Uapl\Ebay\Commerce\Taxonomy\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Uapl\Ebay\Commerce\Taxonomy\Model\CategorySubtree
     */
     ...
     * @throws \Uapl\Ebay\Commerce\Taxonomy\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Uapl\Ebay\Commerce\Taxonomy\Model\CategorySubtree, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCategorySubtreeWithHttpInfo($category_id, $category_tree_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Uapl\Ebay\Commerce\Taxonomy\Model\CategorySubtree' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Uapl\Ebay\Commerce\Taxonomy\Model\CategorySubtree', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Uapl\Ebay\Commerce\Taxonomy\Model\CategorySubtree';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Uapl\Ebay\Commerce\Taxonomy\Model\CategorySubtree',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Uapl\Ebay\Commerce\Taxonomy\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Uapl\Ebay\Commerce\Taxonomy\Model\CategorySuggestionResponse
     */
     ...
     * @throws \Uapl\Ebay\Commerce\Taxonomy\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Uapl\Ebay\Commerce\Taxonomy\Model\CategorySuggestionResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCategorySuggestionsWithHttpInfo($category_tree_id, $q)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Uapl\Ebay\Commerce\Taxonomy\Model\CategorySuggestionResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Uapl\Ebay\Commerce\Taxonomy\Model\CategorySuggestionResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Uapl\Ebay\Commerce\Taxonomy\Model\CategorySuggestionResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Uapl\Ebay\Commerce\Taxonomy\Model\CategorySuggestionResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Uapl\Ebay\Commerce\Taxonomy\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Uapl\Ebay\Commerce\Taxonomy\Model\CategoryTree
     */
     ...
     * @throws \Uapl\Ebay\Commerce\Taxonomy\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Uapl\Ebay\Commerce\Taxonomy\Model\CategoryTree, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCategoryTreeWithHttpInfo($category_tree_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Uapl\Ebay\Commerce\Taxonomy\Model\CategoryTree' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Uapl\Ebay\Commerce\Taxonomy\Model\CategoryTree', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Uapl\Ebay\Commerce\Taxonomy\Model\CategoryTree';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Uapl\Ebay\Commerce\Taxonomy\Model\CategoryTree',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Uapl\Ebay\Commerce\Taxonomy\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Uapl\Ebay\Commerce\Taxonomy\Model\GetCompatibilityMetadataResponse
     */
     ...
     * @throws \Uapl\Ebay\Commerce\Taxonomy\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Uapl\Ebay\Commerce\Taxonomy\Model\GetCompatibilityMetadataResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCompatibilityPropertiesWithHttpInfo($category_tree_id, $category_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Uapl\Ebay\Commerce\Taxonomy\Model\GetCompatibilityMetadataResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Uapl\Ebay\Commerce\Taxonomy\Model\GetCompatibilityMetadataResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Uapl\Ebay\Commerce\Taxonomy\Model\GetCompatibilityMetadataResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Uapl\Ebay\Commerce\Taxonomy\Model\GetCompatibilityMetadataResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Uapl\Ebay\Commerce\Taxonomy\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Uapl\Ebay\Commerce\Taxonomy\Model\GetCompatibilityPropertyValuesResponse
     */
     ...
     * @throws \Uapl\Ebay\Commerce\Taxonomy\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Uapl\Ebay\Commerce\Taxonomy\Model\GetCompatibilityPropertyValuesResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCompatibilityPropertyValuesWithHttpInfo($category_tree_id, $compatibility_property, $category_id, $filter = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Uapl\Ebay\Commerce\Taxonomy\Model\GetCompatibilityPropertyValuesResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Uapl\Ebay\Commerce\Taxonomy\Model\GetCompatibilityPropertyValuesResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Uapl\Ebay\Commerce\Taxonomy\Model\GetCompatibilityPropertyValuesResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Uapl\Ebay\Commerce\Taxonomy\Model\GetCompatibilityPropertyValuesResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Uapl\Ebay\Commerce\Taxonomy\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Uapl\Ebay\Commerce\Taxonomy\Model\BaseCategoryTree
     */
     ...
     * @throws \Uapl\Ebay\Commerce\Taxonomy\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Uapl\Ebay\Commerce\Taxonomy\Model\BaseCategoryTree, HTTP status code, HTTP response headers (array of strings)
     */
    public function getDefaultCategoryTreeIdWithHttpInfo($marketplace_id, $accept_language = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Uapl\Ebay\Commerce\Taxonomy\Model\BaseCategoryTree' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Uapl\Ebay\Commerce\Taxonomy\Model\BaseCategoryTree', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Uapl\Ebay\Commerce\Taxonomy\Model\BaseCategoryTree';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Uapl\Ebay\Commerce\Taxonomy\Model\BaseCategoryTree',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Uapl\Ebay\Commerce\Taxonomy\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Uapl\Ebay\Commerce\Taxonomy\Model\AspectMetadata
     */
     ...
     * @throws \Uapl\Ebay\Commerce\Taxonomy\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Uapl\Ebay\Commerce\Taxonomy\Model\AspectMetadata, HTTP status code, HTTP response headers (array of strings)
     */
    public function getItemAspectsForCategoryWithHttpInfo($category_id, $category_tree_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Uapl\Ebay\Commerce\Taxonomy\Model\AspectMetadata' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Uapl\Ebay\Commerce\Taxonomy\Model\AspectMetadata', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Uapl\Ebay\Commerce\Taxonomy\Model\AspectMetadata';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Uapl\Ebay\Commerce\Taxonomy\Model\AspectMetadata',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
