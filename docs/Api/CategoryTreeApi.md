# Uapl\Ebay\Commerce\Taxonomy\CategoryTreeApi
...
```php
fetchItemAspects($category_tree_id): \Uapl\Ebay\Commerce\Taxonomy\Model\GetCategoriesAspectResponse
```
...
$config = Uapl\Ebay\Commerce\Taxonomy\Configuration::getDefaultConfiguration()->setAccessToken('YOUR_ACCESS_TOKEN');


$apiInstance = new Uapl\Ebay\Commerce\Taxonomy\Api\CategoryTreeApi(
...
[**\Uapl\Ebay\Commerce\Taxonomy\Model\GetCategoriesAspectResponse**](../Model/GetCategoriesAspectResponse.md)
...
```php
getCategorySubtree($category_id, $category_tree_id): \Uapl\Ebay\Commerce\Taxonomy\Model\CategorySubtree
```
...
[**\Uapl\Ebay\Commerce\Taxonomy\Model\CategorySubtree**](../Model/CategorySubtree.md)
...
```php
getCategorySuggestions($category_tree_id, $q): \Uapl\Ebay\Commerce\Taxonomy\Model\CategorySuggestionResponse
```
...
[**\Uapl\Ebay\Commerce\Taxonomy\Model\CategorySuggestionResponse**](../Model/CategorySuggestionResponse.md)
...
```php
getCategoryTree($category_tree_id): \Uapl\Ebay\Commerce\Taxonomy\Model\CategoryTree
```
...
[**\Uapl\Ebay\Commerce\Taxonomy\Model\CategoryTree**](../Model/CategoryTree.md)
...
```php
getCompatibilityProperties($category_tree_id, $category_id): \Uapl\Ebay\Commerce\Taxonomy\Model\GetCompatibilityMetadataResponse
```
...
[**\Uapl\Ebay\Commerce\Taxonomy\Model\GetCompatibilityMetadataResponse**](../Model/GetCompatibilityMetadataResponse.md)
...
```php
getCompatibilityPropertyValues($category_tree_id, $compatibility_property, $category_id, $filter): \Uapl\Ebay\Commerce\Taxonomy\Model\GetCompatibilityPropertyValuesResponse
```
...
[**\Uapl\Ebay\Commerce\Taxonomy\Model\GetCompatibilityPropertyValuesResponse**](../Model/GetCompatibilityPropertyValuesResponse.md)
...
```php
getDefaultCategoryTreeId($marketplace_id, $accept_language): \Uapl\Ebay\Commerce\Taxonomy\Model\BaseCategoryTree
```
...
[**\Uapl\Ebay\Commerce\Taxonomy\Model\BaseCategoryTree**](../Model/BaseCategoryTree.md)
...
```php
getItemAspectsForCategory($category_id, $category_tree_id): \Uapl\Ebay\Commerce\Taxonomy\Model\AspectMetadata
```
...
[**\Uapl\Ebay\Commerce\Taxonomy\Model\AspectMetadata**](../Model/AspectMetadata.md)
